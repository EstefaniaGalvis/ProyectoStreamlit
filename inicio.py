...
st.write("Hecho por: Santiago Hernandez Espejo, Juan Camilo Ossa, Andres, Giselle Lorena, Alexander, Yeraldin, Daniel, Esteban, Estefania Galvis Guainas")

st.header("Introducción a Replay: Portal de Entretenimiento")

st.write("En un panorama de entretenimiento digital en constante evolución, nos complace presentar Replay, una plataforma revolucionaria diseñada para ofrecerte una experiencia de streaming única y personalizada. Con un enfoque en la excelencia tecnológica y la satisfacción del usuario, Replay redefine la forma en que disfrutas del contenido audiovisual.En el corazón de Replay se encuentra una base de datos sofisticada alojada en Firebase, que actúa como el motor de nuestro servicio.")
